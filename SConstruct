...
# CONFIGURATION
FILES = "bin/main.cpp bin/game.cpp bin/detect_to_destroy.cpp bin/detect_to_fall.cpp bin/drawing.cpp bin/hightscores.cpp bin/key_events.cpp bin/preferences.cpp bin/skins-selector.cpp bin/pause.cpp bin/misc.cpp bin/progress_bar.cpp bin/undo.cpp bin/pieces.cpp bin/key.cpp"
