...
bin/options.o : includes/*.h src/menus/options.cpp
	g++ -c -o bin/options.o src/menus/options.cpp $(OPTIONS) $(CFLAGS)
...
bin/undo.o : includes/*.h src/undo.cpp
	g++ -c -o bin/undo.o src/undo.cpp $(OPTIONS) $(CFLAGS)

bin/frontlayer.o : includes/*.h src/frontlayer.cpp
	g++ -c -o bin/frontlayer.o src/frontlayer.cpp $(OPTIONS) $(CFLAGS)

bin/gfx_misc.o : includes/*.h src/gfx_misc.cpp
	g++ -c -o bin/gfx_misc.o src/gfx_misc.cpp $(OPTIONS) $(CFLAGS)
