...
void AudioManager::init()
{
	...
	CL_SoundBuffer vorbis(dir_music + get_path_separator()+ MUSIC_FILE, true);
	...
	_sounds_p[SOUND_MOVE] = my_new CL_SoundBuffer(dir_sound+get_path_separator()+SOUND_MOVE_FILE, false);
	_sounds_p[SOUND_FALL] = my_new CL_SoundBuffer(dir_sound+get_path_separator()+SOUND_FALL_FILE, false);
	_sounds_p[SOUND_CREATION] = my_new CL_SoundBuffer(dir_sound+get_path_separator()+SOUND_CREATION_FILE, false);
	_sounds_p[SOUND_DESTROY] = my_new CL_SoundBuffer(dir_sound+get_path_separator()+SOUND_DESTROY_FILE, false);
