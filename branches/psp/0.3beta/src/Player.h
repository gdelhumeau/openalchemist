...
class Player{
   ...
   */
  SDL_Surface *pieces_normal[NUMBER_OF_PIECES];

  /**
   * Contains the appearing pieces sprites
   */
  SDL_Surface *pieces_appearing[NUMBER_OF_PIECES];

  /**
   * Contains the disappearing pieces sprites
   */
  SDL_Surface *pieces_disappearing[NUMBER_OF_PIECES];

  /**
   * Contains the mini pieces sprites
   */
  SDL_Surface *pieces_mini[NUMBER_OF_PIECES];

  /**
   * Contains the hidden pieces sprites
   */
  SDL_Surface *pieces_hidden[NUMBER_OF_PIECES - 3];
