...
class Board{
   ...
   */
  void apply_skin(SDL_Surface **pieces_normal, SDL_Surface** pieces_appearing, SDL_Surface** pieces_disappearing, SDL_Surface** pieces_mini);
   ...
   */
  void create_new_pieces(SDL_Surface **pieces_normal, SDL_Surface **pieces_appearing, SDL_Surface **pieces_disappearing,
                         SDL_Surface **pieces_mini);
   ...
   * Undoing last action
   */
  void undo(SDL_Surface **pieces_normal, SDL_Surface** pieces_appearing, SDL_Surface** pieces_disappearing, SDL_Surface** pieces_mini);
